  ...
  namespace plugins {
    namespace envire_graphics {
      ...
      public:
        ...
        virtual void itemRemoved(const envire::core::TypedItemAddedEvent<envire::core::Item<maps::grid::MLSMapPrecalculated>>& e);
      ...
      private:
        ...
        osg::ref_ptr<osg::PositionAttitudeTransform> visTf;
